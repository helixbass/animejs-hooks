...
(function(root, factory) {
  ...
  function anime(params) {
    ...
    instance.tick = function(now) {
      ...
      const instanceTime = (lastTime + now - startTime) * anime.speed;
      // const instanceTime = Math.min(Math.max(currentTime, 0), instance.duration);
      // console.log(Math.max(currentTime, 0), instanceTime, instance.duration);
      ...
      if (instanceTime >= instance.duration) {
        ...
        if (instance.remaining) {
          ...
          // setInstanceProgress(instance, instance.duration);
