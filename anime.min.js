...
if(-1<a.indexOf("rotate")||-1<a.indexOf("skew"))return"deg"}function F(a,b){return g.fnc(a)?a(b.target,b.id,b.total):a}function A(a,b){if(b in a.style)return getComputedStyle(a).getPropertyValue(b.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase())||"0"}function G(a,b){if(g.dom(a)&&D(R,b))return"transform";if(g.dom(a)&&a.getAttribute(b))return"attribute";if(g.dom(a)&&"transform"!==b&&A(a,b))return"css";if(null!=a[b])return"object"}function S(a,b){var d=Q(b),d=-1<b.indexOf("scale")?1:0+d;a=a.style.transform;
if(!a)return d;for(var c=[],f=[],k=[],h=/(\w+)\((.+?)\)/g;c=h.exec(a);)f.push(c[1]),k.push(c[2]);a=k.filter(function(a,c){return f[c]===b});return a.length?a[0]:d}function H(a,b){switch(G(a,b)){case "transform":return S(a,b);case "css":return A(a,b);case "attribute":return a.getAttribute(b)}return a[b]||0}function I(a,b){var d=/^(\*=|\+=|-=)/.exec(a);if(!d)return a;b=parseFloat(b);a=parseFloat(a.replace(d[0],""));switch(d[0][0]){case "+":return b+a;case "-":return b-a;case "*":return b*a}}function B(a){return g.obj(a)&&
a.hasOwnProperty("totalLength")}function T(a,b){function d(c){c=void 0===c?0:c;return a.el.getPointAtLength(1<=b+c?b+c:0)}var c=d(),f=d(-1),k=d(1);switch(a.property){case "x":return c.x;case "y":return c.y;case "angle":return 180*Math.atan2(k.y-f.y,k.x-f.x)/Math.PI}}function J(a,b){var d=/-?\d*\.?\d+/g;a=B(a)?a.totalLength:a;if(g.col(a))b=g.rgb(a)?a:g.hex(a)?O(a):g.hsl(a)?P(a):void 0;else{var c=v(a);a=c?a.substr(0,a.length-c.length):a;b=b?a+b:a}b+="";return{original:b,numbers:b.match(d)?b.match(d).map(Number):
[0],strings:b.split(d)}}function U(a,b){return b.reduce(function(b,c,f){return b+a[f-1]+c})}function K(a){return(a?q(g.arr(a)?a.map(t):t(a)):[]).filter(function(a,d,c){return c.indexOf(a)===d})}function V(a){var b=K(a);return b.map(function(a,c){return{target:a,id:c,total:b.length}})}function W(a,b){var d=y(b);if(g.arr(a)){var c=a.length;2!==c||g.obj(a[0])?g.fnc(b.duration)||(d.duration=b.duration/c):a={value:a}}return t(a).map(function(a,c){c=c?0:b.delay;a=g.obj(a)&&!B(a)?a:{value:a};g.und(a.delay)&&
(a.delay=c);return a}).map(function(a){return z(a,d)})}function X(a,b){var d={},c;for(c in a){var f=F(a[c],b);g.arr(f)&&(f=f.map(function(a){return F(a,b)}),1===f.length&&(f=f[0]));d[c]=f}d.duration=parseFloat(d.duration);d.delay=parseFloat(d.delay);return d}function Y(a){return g.arr(a)?w.apply(this,a):L[a]}function Z(a,b){var d;return a.tweens.map(function(c){c=X(c,b);var f=c.value,k=H(b.target,a.name),h=d?d.to.original:k,h=g.arr(f)?f[0]:h,m=I(g.arr(f)?f[1]:f,h),k=v(m)||v(h)||v(k);c.isPath=B(f);
c.from=J(h,k);c.to=J(m,k);c.start=d?d.end:a.offset;c.end=c.start+c.delay+c.duration;c.easing=Y(c.easing);c.elasticity=(1E3-Math.min(Math.max(c.elasticity,1),999))/1E3;g.col(c.from.original)&&(c.round=1);return d=c})}function aa(a,b){var d=a.isPath,c=Math.min(Math.max(b-a.start-a.delay,0),a.duration)/a.duration,f=a.round;return U(a.to.numbers.map(function(b,h){var k=a.easing(c,a.elasticity);h=d?0:a.from.numbers[h];b=h+k*(b-h);d&&(b=T(a.value,b));f&&(b=Math.round(b*f)/f);return b}),a.to.strings)}function ba(a,
b){return q(a.map(function(a){return b.map(function(b){var c=G(a.target,b.name);if(c){var d=Z(b,a);b={type:c,property:b.name,animatable:a,tweens:d,duration:d[d.length-1].end,delay:d[0].delay}}else b=void 0;return b})})).filter(function(a){return!g.und(a)})}function M(a,b,d){var c="delay"===a?Math.min:Math.max;return b.length?c.apply(Math,b.map(function(b){return b[a]})):d[a]}function ca(a){var b=E(da,a),d=E(ea,a),c=V(a.targets),f=[],k=z(b,d),h;for(h in a)k.hasOwnProperty(h)||"targets"===h||f.push({name:h,
offset:k.offset,tweens:W(a[h],d)});a=ba(c,f);return z(b,{animatables:c,animations:a,duration:M("duration",a,d),delay:M("delay",a,d)})}function l(a){function b(a){return e.reversed?e.duration-a:a}function d(a){for(var b={},c=e.animations,d=0;d<c.length;d++){var f=c[d],h=f.tweens,h=h.filter(function(b){return a<b.end})[0]||h[h.length-1],h=aa(h,a),g=f.animatable;(0,fa[f.type])(g.target,f.property,h,b,g.id);f.currentValue=h}if(b)for(var k in b)C||(C=A(document.body,"transform")?"transform":"-webkit-transform"),
e.animatables[k].target.style[C]=b[k].join(" ")}function c(a){if(e[a])e[a](e)}function f(){e.remaining&&!0!==e.remaining&&e.remaining--}function k(a){var k=e.duration,m=e.delay,N=e.currentTime,l=e.reversed,n=b(a),n=Math.min(Math.max(n,0),k);e.currentTime=n;e.progress=n/k*100;n<=m&&0!==N&&(d(0),l&&0>=n&&f());n>m&&n<k&&(d(n),e.began||(e.began=!0,c("begin")),c("run"));n>=k&&N!==k&&(d(k),l||f());a>=k&&(e.remaining?(g=h,"alternate"===e.direction&&(e.reversed=!e.reversed)):(e.completed=!0,e.pause(),c("complete")),
u=0);if(e.children)for(a=e.children,k=0;k<a.length;k++)a[k].seek(n);c("update")}a=void 0===a?{}:a;var h,g,u=0,e=ca(a);e.reset=function(){var a=e.direction,b=e.loop;e.currentTime=0;e.progress=0;e.paused=!0;e.began=!1;e.completed=!1;e.reversed="reverse"===a;e.remaining="alternate"===a&&1===b?2:b};e.tick=function(a){h=a;g||(g=h);k((u+h-g)*l.speed)};e.seek=function(a){k(b(a))};e.pause=function(){var a=p.indexOf(e);-1<a&&p.splice(a,1);e.paused=!0};e.play=function(){e.paused&&(e.paused=!1,g=0,u=e.completed?
0:b(e.currentTime),p.push(e),x||ga())};e.reverse=function(){e.reversed=!e.reversed;g=0;u=b(e.currentTime)};e.restart=function(){e.pause();e.reset();e.play()};e.reset();e.autoplay&&e.play();return e}var da={update:void 0,begin:void 0,run:void 0,complete:void 0,loop:1,direction:"normal",autoplay:!0,offset:0},ea={duration:1E3,delay:0,easing:"easeOutElastic",elasticity:500,round:0},R="translateX translateY translateZ rotate rotateX rotateY rotateZ scale scaleX scaleY scaleZ skewX skewY".split(" "),C,
...
var m=a(e,b,c)-h,e=e-m/l}h=e}else if(0===l)h=e;else{var e=g,g=g+.1,p=0;do m=e+(g-e)/2,l=a(m,b,c)-h,0<l?g=m:e=m;while(1e-7<Math.abs(l)&&10>++p);h=m}return a(h,d,f)}}}}(),L=function(){function a(a,b){return 0===a||1===a?a:-Math.pow(2,10*(a-1))*Math.sin(2*(a-1-b/(2*Math.PI)*Math.asin(1))*Math.PI/b)}var b="Quad Cubic Quart Quint Sine Expo Circ Back Elastic".split(" "),d={In:[[.55,.085,.68,.53],[.55,.055,.675,.19],[.895,.03,.685,.22],[.755,.05,.855,.06],[.47,0,.745,.715],[.95,.05,.795,.035],[.6,.04,.98,
