...
C(e);d.from=K(g,k);d.to=K(n,k);d.start=c?c.end:a.offset;d.end=d.start+d.delay+d.duration;d.easing=ba(d.easing);d.elasticity=(1E3-Math.min(Math.max(d.elasticity,1),999))/1E3;h.col(d.from.original)&&(d.round=1);return c=d})}function da(a,b){var c=a.isPath,d=Math.min(Math.max(b-a.start-a.delay,0),a.duration)/a.duration,e=a.round;return X(a.to.numbers.map(function(b,g){var k=a.easing(d,a.elasticity);g=c?0:a.from.numbers[g];b=g+k*(b-g);c&&(b=W(a.value,b));e&&(b=Math.round(b*e)/e);return b}),a.to.strings)}
function ea(a,b){return r(a.map(function(a){return b.map(function(b){var c=H(a.target,b.name);if(c){var d=ca(b,a);b={type:c,property:b.name,animatable:a,tweens:d,duration:d[d.length-1].end,delay:d[0].delay}}else b=void 0;return b})})).filter(function(a){return!h.und(a)})}function N(a,b,c){var d="delay"===a?Math.min:Math.max;return b.length?d.apply(Math,b.map(function(b){return b[a]})):c[a]}function fa(a){var b=F(ga,a),c=F(ha,a),d=Y(a.targets),e=[],k=A(b,c),g;for(g in a)k.hasOwnProperty(g)||"targets"===
g||e.push({name:g,offset:k.offset,tweens:Z(a[g],c)});a=ea(d,e);return A(b,{animatables:d,animations:a,duration:N("duration",a,c),delay:N("delay",a,c)})}function m(a){function b(){return window.Promise&&new Promise(function(a){return P=a})}function c(a){return f.reversed?f.duration-a:a}function d(a){for(var b={},c=f.animations,d=0;d<c.length;d++){var e=c[d],g=e.tweens,g=g.filter(function(b){return a<b.end})[0]||g[g.length-1],g=da(g,a),h=e.animatable;(0,ia[e.type])(h.target,e.property,g,b,h.id);e.currentValue=
g}if(b)for(var k in b)D||(D=B(document.body,"transform")?"transform":"-webkit-transform"),f.animatables[k].target.style[D]=b[k].join(" ");f.currentTime=a;f.progress=a/f.duration*100}function e(a){if(f[a])f[a](f)}function k(){f.remaining&&!0!==f.remaining&&f.remaining--}function g(a){var g=f.duration,n=f.offset,m=f.delay,O=f.currentTime,p=f.reversed,q=c(a),q=Math.min(Math.max(q,0),g);q>n&&q<g?(d(q),!f.began&&q>=m&&(f.began=!0,e("begin")),e("run")):(q<=n&&0!==O&&(d(0),p&&k()),q>=g&&O!==g&&(d(g),p||
k()));a>=g&&(f.remaining?(t=h,"alternate"===f.direction&&(f.reversed=!f.reversed)):(f.pause(),P(),Q=b(),f.completed||(f.completed=!0,e("complete"))),l=0);if(f.children)for(a=f.children,g=0;g<a.length;g++)a[g].seek(q);e("update")}a=void 0===a?{}:a;var h,t,l=0,P=null,Q=b(),f=fa(a);f.reset=function(){var a=f.direction,b=f.loop;f.currentTime=0;f.progress=0;f.paused=!0;f.began=!1;f.completed=!1;f.reversed="reverse"===a;f.remaining="alternate"===a&&1===b?2:b};f.tick=function(a){h=a;t||(t=h);g((l+h-t)*m.speed)};
f.seek=function(a){g(c(a))};f.pause=function(){var a=p.indexOf(f);-1<a&&p.splice(a,1);f.paused=!0};f.play=function(){f.paused&&(f.paused=!1,t=0,l=f.completed?0:c(f.currentTime),p.push(f),y||ja())};f.reverse=function(){f.reversed=!f.reversed;t=0;l=c(f.currentTime)};f.restart=function(){f.pause();f.reset();f.play()};f.finished=Q;f.reset();f.autoplay&&f.play();return f}var ga={update:void 0,begin:void 0,run:void 0,complete:void 0,loop:1,direction:"normal",autoplay:!0,offset:0},ha={duration:1E3,delay:0,
...
rgb:function(a){return/^rgb/.test(a)},hsl:function(a){return/^hsl/.test(a)},col:function(a){return h.hex(a)||h.rgb(a)||h.hsl(a)}},x=function(){function a(a,c,d){return(((1-3*d+3*c)*a+(3*d-6*c))*a+3*c)*a}return function(b,c,d,e){if(0<=b&&1>=b&&0<=d&&1>=d){var h=new Float32Array(11);if(b!==c||d!==e)for(var g=0;11>g;++g)h[g]=a(.1*g,b,d);return function(g){if(b===c&&d===e)return g;if(0===g)return 0;if(1===g)return 1;for(var k=0,l=1;10!==l&&h[l]<=g;++l)k+=.1;--l;var l=k+(g-h[l])/(h[l+1]-h[l])*.1,n=3*(1-
3*d+3*b)*l*l+2*(3*d-6*b)*l+3*b;if(.001<=n){for(k=0;4>k;++k){n=3*(1-3*d+3*b)*l*l+2*(3*d-6*b)*l+3*b;if(0===n)break;var m=a(l,b,d)-g,l=l-m/n}g=l}else if(0===n)g=l;else{var l=k,k=k+.1,f=0;do m=l+(k-l)/2,n=a(m,b,d)-g,0<n?k=m:l=m;while(1e-7<Math.abs(n)&&10>++f);g=m}return a(g,c,e)}}}}(),M=function(){function a(a,b){return 0===a||1===a?a:-Math.pow(2,10*(a-1))*Math.sin(2*(a-1-b/(2*Math.PI)*Math.asin(1))*Math.PI/b)}var b="Quad Cubic Quart Quint Sine Expo Circ Back Elastic".split(" "),c={In:[[.55,.085,.68,
