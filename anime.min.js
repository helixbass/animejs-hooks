...
c){return f.fnc(a)?a(c.target,c.id,c.total):a}function U(a,c){var d={},b;for(b in a){var e=H(a[b],c);f.arr(e)&&(e=e.map(function(a){return H(a,c)}),1===e.length&&(e=e[0]));d[b]=e}d.duration=parseFloat(d.duration);d.delay=parseFloat(d.delay);return d}function V(a){return f.arr(a)?u.apply(this,a):I[a]}function W(a,c){var d;return a.tweens.map(function(b){b=U(b,c);var e=b.value,g=E(c.target,a.name),h=d?d.to.original:g,h=f.arr(e)?e[0]:h,k=f.arr(e)?e[1]:e,g=t(k)||t(h)||t(g);e=(e=/^(\*=|\+=|-=)/.exec(k))?
e[0]:void 0;if(e)a:{var p=k,k=parseFloat(h),p=parseFloat(p.replace(e,""));switch(e[0]){case "+":k+=p;break a;case "-":k-=p;break a;case "*":k*=p;break a}k=void 0}b.from=F(h,g);b.to=F(k,g);b.start=d?d.end+b.delay:b.delay;b.end=b.start+b.duration;b.easing=V(b.easing);b.elasticity=(1E3-Math.min(Math.max(b.elasticity,1),999))/1E3;f.col(b.from.original)&&(b.round=1);return d=b})}function X(a,c){var d=Math.min(Math.max(c-a.start,0),a.duration)/a.duration,b=a.round;return Q(a.to.numbers.map(function(c,g){var e=
a.easing(d,a.elasticity);g=a.from.numbers[g];c=g+e*(c-g);z(a.value)&&(c=P(a.value,c));b&&(c=Math.round(c*b)/b);return c}),a.to.strings)}function Y(a,c){var d=D(a.target,c.name);if(d){var b=W(c,a);return{type:d,property:c.name,animatable:a,tweens:b,duration:b.reduce(function(a,b){return a+b.delay+b.duration},0),delay:b[0].delay}}}function Z(a,c){return n(a.map(function(a){return c.map(function(b){return Y(a,b)})})).filter(function(a){return!f.und(a)})}function aa(a,c){a=a.children;for(var d=0;d<a.length;d++)a[d].seek(c)}
function J(a,c){var d={},b=a.animations,e=a.reversed?a.duration-c:c;a.currentTime=e;a.progress=e/a.duration*100;for(c=0;c<b.length;c++){var g=b[c],h=g.tweens,h=h.filter(function(a){return a.start-a.delay<=e&&a.end>=e})[0]||h[h.length-1],h=X(h,e),k=g.animatable;(0,ba[g.type])(k.target,g.property,h,d,k.id);g.currentValue=h}if(d)for(var f in d)A||(A=y(document.body,"transform")?"transform":"-webkit-transform"),a.animatables[f].target.style[A]=d[f].join(" ");a.update&&a.update(a);a.children&&aa(a,e)}
function ca(a){a=void 0===a?{}:a;var c=C(da,a),d=C(ea,a),b=R(a.targets);a=T(c,d,a);a=Z(b,a);return x(c,{animatables:b,animations:a,duration:a.length?Math.max.apply(Math,a.map(function(a){return a.duration})):d.duration,delay:a.length?Math.min.apply(Math,a.map(function(a){return a.delay})):d.delay,currentTime:0,progress:0,paused:!0,began:!1,completed:!1,remaining:c.loop})}function l(a){var c,d=0,b=ca(a);b.tick=function(a){c||(c=a);var e=Math.min(Math.max((d+a-c)*l.speed,0),b.duration);J(b,e);!b.began&&
e>=b.delay&&(b.began=!0,b.begin&&b.begin(b));e>=b.duration&&(b.remaining&&!isNaN(parseFloat(b.remaining))&&b.remaining--,b.remaining?(c=a,"alternate"===b.direction&&(b.reversed=!b.reversed)):(b.completed=!0,b.began=!1,b.pause(),b.complete&&b.complete(b)),d=0)};b.seek=function(a){J(b,b.reversed?b.duration-a:a)};b.pause=function(){var a=m.indexOf(b);-1<a&&m.splice(a,1);b.paused=!0};b.play=function(){if(b.paused){b.paused=!1;c=0;var a;b.completed?a=0:(a=b.currentTime,a=b.reversed?b.duration-a:a);d=a;
"reverse"!==b.direction||b.reversed||(b.reversed=!b.reversed);"alternate"===b.direction&&(b.reversed&&!b.remaining%2&&(b.reversed=!b.reversed),b.remaining||(b.remaining=2));m.push(b);v||fa()}};b.restart=function(){b.pause();b.reversed&&(b.reversed=!b.reversed);b.completed=!1;b.began=!1;b.remaining=b.loop;b.seek(0);b.play()};b.autoplay&&b.restart();return b}var da={begin:void 0,update:void 0,complete:void 0,loop:0,direction:"normal",autoplay:!0},ea={duration:1E3,delay:0,easing:"easeOutElastic",elasticity:500,
round:0},N="translateX translateY translateZ rotate rotateX rotateY rotateZ scale scaleX scaleY scaleZ skewX skewY".split(" "),A,f={arr:function(a){return Array.isArray(a)},obj:function(a){return-1<Object.prototype.toString.call(a).indexOf("Object")},svg:function(a){return a instanceof SVGElement},dom:function(a){return a.nodeType||f.svg(a)},str:function(a){return"string"===typeof a},fnc:function(a){return"function"===typeof a},und:function(a){return"undefined"===typeof a},hex:function(a){return/(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(a)},
rgb:function(a){return/^rgb/.test(a)},hsl:function(a){return/^hsl/.test(a)},col:function(a){return f.hex(a)||f.rgb(a)||f.hsl(a)}},u=function(){function a(a,d,b){return(((1-3*b+3*d)*a+(3*b-6*d))*a+3*d)*a}return function(c,d,b,e){if(0<=c&&1>=c&&0<=b&&1>=b){var f=new Float32Array(11);if(c!==d||b!==e)for(var h=0;11>h;++h)f[h]=a(.1*h,c,b);return function(h){if(c===d&&b===e)return h;if(0===h)return 0;if(1===h)return 1;for(var g=0,k=1;10!==k&&f[k]<=h;++k)g+=.1;--k;var k=g+(h-f[k])/(f[k+1]-f[k])*.1,l=3*(1-
3*b+3*c)*k*k+2*(3*b-6*c)*k+3*c;if(.001<=l){for(g=0;4>g;++g){l=3*(1-3*b+3*c)*k*k+2*(3*b-6*c)*k+3*c;if(0===l)break;var m=a(k,c,b)-h,k=k-m/l}h=k}else if(0===l)h=k;else{var k=g,g=g+.1,n=0;do m=k+(g-k)/2,l=a(m,c,b)-h,0<l?g=m:k=m;while(1e-7<Math.abs(l)&&10>++n);h=m}return a(h,d,e)}}}}(),I=function(){function a(a,b){return 0===a||1===a?a:-Math.pow(2,10*(a-1))*Math.sin(2*(a-1-b/(2*Math.PI)*Math.asin(1))*Math.PI/b)}var c="Quad Cubic Quart Quint Sine Expo Circ Back Elastic".split(" "),d={In:[[.55,.085,.68,
